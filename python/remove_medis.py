...
def exec(target):
    target = remove_markup(target)
    target = remove_link(target)
    target = remove_lang(target)
    target = remove_url(target)
    target = remove_tag(target)
    return target    
